...
function saveLotsToStorage(lots) {
    localStorage.setItem('inventoryLots', JSON.stringify(lots));
}

// Cargar lotes desde localStorage
function loadLotsFromStorage() {
    const storedLots = localStorage.getItem('inventoryLots');
    return storedLots ? JSON.parse(storedLots) : [];
}

// =============================================
// DATOS INICIALES (solo se usan si no hay datos en localStorage)
// =============================================
...
const initialTickets = [
    {
        ...
        incidentDate: new Date().getTime() - 2 * 24 * 60 * 60 * 1000
    },
    {
        id: "DI-010",
        client: "Fendi",
        ...
        incidentDate: new Date().getTime() - 3 * 24 * 60 * 60 * 1000
    },
    {
        id: "DI-009",
        client: "Jorge López",
        ...
        incidentDate: new Date().getTime() - 5 * 24 * 60 * 60 * 1000
    },
    {
        id: "DI-008",
        ...
        incidentDate: new Date().getTime() - 7 * 24 * 60 * 60 * 1000
    }
];
...
// =============================================
// FUNCIONES PRINCIPALES (actualizadas con localStorage)
// =============================================
...
function initApp() {
    ...
    let lots = loadLotsFromStorage();
    if (lots.length === 0) {
        lots = initialLots;
        saveLotsToStorage(lots);
    }
...
function createNewLot() {
    ...
    const lots = loadLotsFromStorage();
